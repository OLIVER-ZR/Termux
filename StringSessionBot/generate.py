...
async def generate_session(bot, msg, telethon=False):
    ...
    try:
        ...
        try:
            two_step_msg = await bot.ask(user_id, 'حسابك يحتوي على التحقق بخطوتين - قم بكتابة الرمز لاتخاف حسابك آمن لدى الحفرة .', filters=filters.text, timeout=300)
        except TimeoutError:
